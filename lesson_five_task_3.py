...
school_gen = ((tutor, klass) for tutor, klass in zip(tutors, klasses))

print(next(school_gen), next(school_gen), next(school_gen), next(school_gen), next(school_gen), next(school_gen), next(school_gen))



# Подсмотрел у вас!
gen = ((tutor, klass) for tutor, klass in zip_longest(tutors, klasses))
print(next(gen),next(gen), next(gen), next(gen), next(gen), next(gen), next(gen), next(gen))
